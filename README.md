...
**Method 2:**  
Download the [latest release from GitHub](https://github.com/jan-hofmeier/isfshax-loader/releases), and extract the `isfshax_loader.zip` file to the root of your SD card.
...
## Credits
 ...
 - [Jan](https://github.com/jan-hofmeier) for ISFShax Loader
...
## License
ISFShax Loader is licensed under [MIT](https://github.com/jan-hofmeier/isfshax-loader/blob/master/LICENSE.md).
ISFShax Loader uses [fatfs](http://elm-chan.org/fsw/ff/00index_e.html), see its BSD-styled license [here](https://github.com/emiyl/dumpling/blob/master/source/utils/fatfs/LICENSE.txt).
