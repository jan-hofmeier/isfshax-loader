...
/* Command code for disk_ioctl function (BYTE cmd) */
...
#define GET_SECTOR_SHIFT	11	/* Get sector shift */
...
#define IS_MMC(drv)			(drv & 0x01)	/* Is card MMC */
#define IS_SD(drv)			(drv & 0x02)	/* Is card SDC */
#define IS_BLOCK(drv)		(drv & 0x04)	/* Is card block addressable */
